...
if rafMid > 0 and rkipMid > 0:
    # Add the original chemical intervals
    if k > 0:
        create_clause(0, raf)
...
if raf1rkiperkppMid > 0:
    ...
    if k > 0:
        ...
        k -= 1
    # Calculate the product of the reaction (minMid * rate of reaction)
    product = raf1rkiperkppMid * 0.0315
